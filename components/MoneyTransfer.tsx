      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-teal-50 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-teal-800">Servicio Financiero Bodipo</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-black text-[#00151a] tracking-tighter leading-none">
            Mueve tu dinero <br /><span className="text-[#007e85]">al mundo con nosotros.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-[3rem] border border-gray-100 p-8 md:p-12 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="space-y-6">
                <p className="text-xs font-black uppercase tracking-widest text-[#007e85]">Datos del Remitente</p>
                <input type="text" placeholder="Nombre Completo" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                <input type="text" placeholder="ID / Pasaporte" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                <input type="text" placeholder="Teléfono" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
              </div>
              <div className="space-y-6">
                <p className="text-xs font-black uppercase tracking-widest text-[#007e85]">Datos del Beneficiario</p>
                <input type="text" placeholder="Nombre Completo" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                {direction !== 'GQ_ES' ? (
                  <>
                    <input type="text" placeholder="ID / Pasaporte Beneficiario" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                    <input type="text" placeholder="Número de Teléfono" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                  </>
                ) : (
                  <>
                    <input type="text" placeholder="IBAN Destino" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                    <input type="text" placeholder="Número de Bizum" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-medium focus:ring-2 focus:ring-teal-500" />
                  </>
                )}
              </div>
            </div>
            ...
            <div className="bg-teal-50 rounded-3xl p-8 mb-10 border border-teal-100">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1 w-full">
                  <label className="text-[10px] font-black uppercase tracking-widest text-teal-800 mb-2 block">Cantidad a Enviar</label>
                  <div className="relative">
                    <input
                      type="number"
                      value={amount || ''}
                      onChange={(e) => setAmount(parseFloat(e.target.value) || 0)}
                      className="w-full bg-white border-none rounded-2xl px-6 py-5 text-2xl font-black focus:ring-2 focus:ring-teal-500 outline-none"
                      placeholder="0.00"
                    />
                ...
                <div className="flex-1 w-full">
                  <label className="text-[10px] font-black uppercase tracking-widest text-teal-800 mb-2 block">
                    {direction === 'CM_GQ' ? 'Costo total con cargo 4%' : 'Recibirá aproximadamente'}
                  </label>
              ...
              <div className="mt-6 flex flex-col md:flex-row justify-between text-[10px] font-bold text-teal-700 uppercase tracking-widest gap-2">
                <span>
                  {direction === 'ES_GQ' && `Tasa: 1€ = ${rateEURO_CFA} CFA`}
                  {direction === 'GQ_ES' && `Tasa: ${rateCFA_EURO} CFA = 1€`}
                  {direction === 'CM_GQ' && `Cargo por servicio: 4%`}
                </span>
                <span className="italic">Del mundo hasta Guinea con Nosotros</span>
              </div>
            </div>

            <div className="space-y-4">
              <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block">Subir Comprobante de Operación</label>
              <div className="relative border-2 border-dashed border-gray-200 rounded-3xl p-8 text-center hover:border-teal-400 transition-colors group">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-bold text-gray-500">
                    {file ? file.name : 'Adjunta imagen o PDF del ingreso'}
                  </p>
                </div>
              </div>
              <button className="w-full bg-[#00151a] text-white py-6 rounded-3xl font-black uppercase tracking-[0.2em] text-xs hover:bg-[#007e85] transition-all shadow-xl shadow-teal-900/10 mt-6">
                Notificar Envío de Dinero
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-[#00151a] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black mb-8 border-b border-white/10 pb-4">Cuentas para Transferencias</h3>
              ...
              <div className="space-y-10">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-teal-400">🇬🇶 Ecobank Equatorial Guinea</p>
                  </div>
                  <div className="bg-white/5 rounded-2xl p-6 space-y-3 border border-white/5">
                    <p className="text-[10px] font-bold text-gray-400 uppercase">Nombre de la cuenta</p>
                    <p className="text-sm font-black uppercase">SUSANA MBA MIKUE.</p>
                    <p className="text-[10px] font-bold text-gray-400 uppercase">IBAN / Número de cuenta</p>
                    <p className="text-lg font-mono font-black text-teal-300">39360018962</p>
                    <div className="pt-2 border-t border-white/5">
                      <p className="text-[10px] font-bold text-gray-400 uppercase">Código SWIFT</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-yellow-400">🇪🇸 España (Revolut)</p>
                  </div>
                  <div className="bg-white/5 rounded-2xl p-6 space-y-3 border border-white/5">
                    ...
                    <p className="text-[10px] font-bold text-gray-400 uppercase">IBAN</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-green-400">🇨🇲 Sede Camerún</p>
                  </div>
            ...
            <div className="p-8 border-2 border-dashed border-gray-100 rounded-[2.5rem] flex items-center space-x-6">
              ...
              <p className="text-sm font-medium text-gray-400 leading-relaxed">
                <span className="text-[#00151a] font-bold">Bodipo Business:</span> Puedes mover tu dinero desde Guinea Ecuatorial hasta el mundo.
              </p>
            </div>
          </div>
        </div>
