        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center space-x-3 bg-teal-500/10 px-4 py-2 rounded-2xl mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-widest text-teal-800">Bodipo Official Merch</span>
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-[#00151a] tracking-tighter leading-none mb-8">
              Bodipo <br /><span className="text-[#007e85]">Collection.</span>
            </h2>
            <p className="text-xl text-gray-500 font-medium leading-relaxed">
              Nuestra ropa no es solo moda, es una declaración de intenciones. Calidad premium con <span className="text-[#00151a] font-bold">envío internacional incluido</span> en el precio.
            </p>
          </div>
          ...
          <div className="bg-[#00151a] p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group text-center min-w-[280px]">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-teal-400 mb-2">Precio Final</p>
            <div className="flex flex-col items-center">
              ...
              <div className="mt-4 flex items-center space-x-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-white">Envío Incluido</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div key={product.id} className="group flex flex-col">
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#00151a]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-12 text-center backdrop-blur-[4px] pointer-events-none">
                  ...
                  <span className="mt-4 text-[8px] uppercase tracking-widest text-white/50">Click para ampliar</span>
                </div>
                ...
                <div className="absolute top-10 left-10 pointer-events-none">
                  <div className="bg-white/95 backdrop-blur px-6 py-3 rounded-2xl shadow-xl flex flex-col items-start gap-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-widest text-teal-600">Stock Disponible</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 px-4">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <span className="bg-teal-100 text-[#007e85] px-2 py-0.5 rounded-lg text-[8px] font-black uppercase tracking-tighter mt-1 inline-block">Envío 0€</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-center justify-center space-x-3 opacity-40">
                    <span className="text-[8px] font-black uppercase tracking-widest text-gray-500">Pagos Seguros</span>
                    <span className="w-1 h-1 bg-gray-300 rounded-full"></span>
                    <span className="text-[8px] font-black uppercase tracking-widest text-gray-500">Recogida en Oficina</span>
                  </div>
                </div>
              </div>
            </div>
