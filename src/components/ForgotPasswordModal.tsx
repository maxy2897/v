                ...
                <div className="p-6 md:p-8">
                    ...
                    {method === 'phone' && step === 'input' && (
                        <div className="text-center space-y-6 animate-in fade-in duration-300">
                            ...
                            <div>
                                <h3 className="text-lg font-black text-[#00151a] mb-2">Verificación Manual Requerida</h3>
                                <p className="text-sm text-gray-500 leading-relaxed">
                                    Por seguridad, la recuperación vía móvil se realiza manualmente. Contacta con nuestro soporte en WhatsApp para verificar tu identidad y restablecer tu contraseña.
                                </p>
                            </div>
                            <a
                                href="https://wa.me/34643521042?text=Hola,%20necesito%20recuperar%20el%20acceso%20a%20mi%20cuenta%20de%20Bodipo%20Business.%20Mi%20nombre%20es:%20(Escribe%20aqu%C3%AD%20tu%20nombre)%20y%20mi%20correo%20es:%20(Escribe%20aqu%C3%AD%20tu%20email)"
                                target="_blank"
