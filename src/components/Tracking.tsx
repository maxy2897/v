...
const Tracking: React.FC = () => {
  ...
  return (
    <section id="rastreo" className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 z-0 bg-[url('/images/bg/tracking-net-v2.png')] bg-cover bg-center bg-fixed blur-[3px] brightness-[1.2]"></div>
