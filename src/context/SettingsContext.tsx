...
const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        'nav.online_shopping': 'Compras Online',
        'nav.store': 'Tienda',
        ...
        'admin.market_share': 'Cuota de Mercado por Rutas',
        'admin.shipment_evolution': 'Evolución de Envíos (Mensual)',
        ...
        'about.member_nguema_name': 'D. V. Nguema Elebiyo Mangue',
        ...
        'about.member_martin_name': 'D.A. MARTIN NDONG',
        ...
        'about.member_dr_name': 'D.R. NGUEMA',
    ...
    en: {
        ...
        'nav.rates': 'Shipments',
        'nav.money_transfer': 'Money Transfer',
        'nav.online_shopping': 'Online Shopping',
        'nav.store': 'Store',
        ...
        // Terms and Conditions
        'terms.title.1': '1. General Conditions',
        'terms.content.1': 'These General Conditions apply when BODIPO BUSINESS (hereinafter BODIPO) accepts the shipment, unless otherwise agreed or specified in another contract for logistics and transportation services.',
        'terms.title.2': '2. Shipment Data and Service Restrictions',
        'terms.content.2': 'The sender or loader provides under their responsibility the contractual data related to the nature of the goods, sender, and recipient. BODIPO does not offer transportation services for dangerous (ADR) or perishable goods.',
        'terms.title.3': '3. Delivery Times',
        'terms.content.3': 'Shipments must be collected at BODIPO logistics centers: Madrid, Malabo, Bata, Yaounde. Approximate delivery times: Madrid — Malabo (2 days), Madrid — Bata (3 days), Bata — Malabo and vice versa (1 day).',
        'terms.title.4': '4. Delivery Delay',
        'terms.content.4': 'Delay in delivery produced by absence or change of address of the recipient, non-payment of postage, refunds, closure for holidays, post-deadline deliveries, force majeure, or any other cause not attributable to BODIPO shall not be considered a delay.',
        'terms.title.5': '5. Liability and Insurance',
        'terms.content.5': 'In the absence of an express declaration of the value of the goods before hiring the transportation service, BODIPO\'s liability limit for damage or lack of consigned goods is 1/3 of the daily IPREM (6.67€/kg).',
        'terms.title.6': '6. Complaint and Reservations',
        'terms.content.6': 'In case of damage or loss of the goods, the recipient must indicate at the time of delivery and in writing on the delivery note what such damage or loss consists of within 24 hours for apparent damage.',
        'terms.title.7': '7. Packaging',
        'terms.content.7': 'Shipments will be delivered with adequate and sufficient packaging. In case of insufficient packaging, BODIPO will perform it correctly, passing the costs for said service to the customer.',
        'terms.title.8': '8. Refunds',
        'terms.content.8': 'The refund service is only available for subscribed customers or those with a code. For more information, contact our customer service.',
        'terms.title.9': '9. Deposit and Disposal of Goods',
        'terms.content.9': 'In cases of impediments to transport or delivery, non-payment of freight or expenses, BODIPO may unload the goods and guard them at the expense of whoever has the right over them.',
        'terms.title.10': '10. Customs Clearance',
        'terms.content.10': 'The sender must provide the appropriate documentation for Customs Clearance, being responsible for its veracity and validity.',
        'terms.title.11': '11. Jurisdiction',
        'terms.content.11': 'Any difference in the application or interpretation of these general conditions shall be submitted to the competence of the Transport Arbitration Board that the parties choose voluntarily.',
        ...
        'about.member_nguema_name': 'Mr. V. Nguema Elebiyo Mangue',
        'about.member_martin_role': 'Product Design',
        ...
        'about.member_martin_name': 'Mr. Martin Ndong',
    ...
    fr: {
        ...
        'nav.online_shopping': 'Achats en Ligne',
        'nav.store': 'Boutique',
        ...
        'terms.title.1': '1. Conditions Générales',
        ...
        'terms.title.2': '2. Données d\'Expédition et Restrictions de Service',
        'terms.content.2': 'L\'expéditeur ou le chargeur fournit sous sa responsabilité les données contractuelles relatives à la nature des marchandises, à l\'expéditeur et au destinataire. BODIPO ne propose pas de services de transport de marchandises dangereuses (ADR) ou périssables.',
        'terms.title.3': '3. Délais de Livraison',
        'terms.content.3': 'Les expéditions doivent être retirées dans les centres logistiques de BODIPO : Madrid, Malabo, Bata, Yaoundé. Délais de livraison approximatifs : De Madrid — Malabo (2 jours), Madrid — Bata (3 jours), De Bata — Malabo et vice versa (1 jour).',
        'terms.title.4': '4. Retard de Livraison',
        'terms.content.4': 'Ne sera pas considéré comme retard de livraison celui produit par l\'absence ou le changement d\'adresse du destinataire, le non-paiement du port, les remboursements, la fermeture pour congés, les livraisons hors délai lors de la deuxième tentative de livraison ou suivantes, les cas de force majeure ou cas fortuit, ou tout autre non imputable à BODIPO.',
        'terms.title.5': '5. Responsabilité et Assurance',
        'terms.content.5': 'À défaut de déclaration expresse de la valeur de la marchandise avant la souscription du service de transport, la limite de responsabilité de BODIPO pour dommage ou manque de la marchandise consignée pour le transport est de 1/3 de l\'IPREM journalier (6,67€/kg).',
        'terms.title.6': '6. Réclamation et Réserves',
        'terms.content.6': 'En cas de dommages ou de pertes sur la marchandise, le destinataire devra indiquer au moment de la livraison et par écrit sur le bon de livraison en quoi consistent ces dommages ou manques dans un délai de 24 heures s\'il s\'agit de dommages apparents.',
        'terms.title.7': '7. Emballage',
        'terms.content.7': 'Les expéditions seront livrées avec l\'emballage adéquat et suffisant. En cas d\'emballage insuffisant, BODIPO le réalisera correctement, en répercutant les frais de ce service sur le client.',
        'terms.title.8': '8. Remboursements',
        'terms.content.8': 'Le service de remboursement n\'est disponible que pour les clients abonnés ou avec code. Pour plus d\'informations, contactez notre service client.',
        'terms.title.9': '9. Dépôt et Aliénation de la Marchandise',
        'terms.content.9': 'En cas d\'empêchement au transport ou à la livraison, de non-paiement du port ou des frais ou du remboursement, BODIPO pourra décharger la marchandise et la garder pour le compte de celui qui a droit sur celle-ci.',
        'terms.title.10': '10. Dédouanement',
        'terms.content.10': 'L\'expéditeur devra fournir la documentation appropriée pour le dédouanement, étant responsable de sa véracité et de sa validité.',
        'terms.title.11': '11. Juridiction',
        'terms.content.11': 'Tout différend relatif à l\'application ou à l\'interprétation des présentes conditions générales sera soumis à la compétence du Conseil d\'Arbitrage des Transports que les parties choisiront volontairement.',
