                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                        <div className="lg:col-span-7 space-y-8">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black text-[#00151a] tracking-tighter leading-[0.9]">
                                Servicio Internacional <br />
                                de <span className="text-[#007e85]">Envíos de Paquetes.</span>
                            </h1>
                            ...
                            <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.15)] bg-[#00151a]">
                                ...
                                <div className="absolute bottom-10 left-10 text-white">
                                    <div className="flex items-center space-x-3 mb-2">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest text-teal-400">Servicio Estrella</span>
                                    </div>
                                    <p className="text-3xl font-black flex items-center gap-3">🇪🇸 España ➔ 🇬🇶 Guinea</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 relative z-10">
                            <div className="p-12 md:p-20 flex flex-col justify-center">
                                <div className="inline-flex items-center space-x-2 bg-teal-500/10 px-4 py-2 rounded-full mb-8 w-fit">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-teal-400">Servicio Financiero</span>
                                </div>
                                <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-none mb-8">
                                    Mueve tu dinero <br />
                                    <span className="text-teal-400">al mundo con nosotros.</span>
                                </h2>
                                <p className="text-gray-400 text-lg font-medium leading-relaxed mb-12 max-w-md">
                                    Envía y recibe dinero de forma segura, rápida y con las mejores tasas del mercado. Conectamos tus finanzas con el resto del mundo.
                                </p>
                                <a
                                    href="/money-transfer"
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-teal-400 font-bold uppercase text-[10px] tracking-widest">
                                Regístrate gratis y desbloquea beneficios exclusivos en envíos por volumen
                            </p>
                        </div>
                        <a
                            href="/acceso"
