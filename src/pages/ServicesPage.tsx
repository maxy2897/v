        ...
        <>
            ...
            <section className="py-20 bg-transparent">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-[1.75rem] p-8 md:p-12 shadow-sm border border-gray-100 dark:border-white/5 relative overflow-hidden">
